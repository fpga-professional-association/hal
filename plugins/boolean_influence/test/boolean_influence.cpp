...
namespace hal
{
    ...
    protected:
         ...
         * `SecondDataPin::DrivenByLogic` the secondary data pin is driven by an inverter of its own instead
         * of being tied off, which makes the data input genuinely ambiguous.
         */
     ...
     * Functions: get_boolean_influences_of_gate_deterministic
     */
    TEST_F(BooleanInfluenceTest, check_second_data_pin_without_a_source_is_unconnected)
    {
        TEST_START
        {
