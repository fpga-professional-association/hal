// ---------------------------------------------------------------------------
// core_c -- GROUND TRUTH for walkthrough 16.  Do not read this while doing the
// exercise; cores/core_c.anon.hal.v is the exercise.
//
// This is walkthrough 13's design.v verbatim below the header, with the
// top-level module renamed `core_c` so that it synthesizes into its own Quartus
...
// ---------------------------------------------------------------------------
// core_c -- the "original design" of Agilex 3 walkthrough 13.
//
