// ---------------------------------------------------------------------------
// core_d -- GROUND TRUTH for walkthrough 16.  Do not read this while doing the
// exercise; cores/core_d.anon.hal.v is the exercise.
//
// This is walkthrough 11's design.v verbatim below the header, with the
// top-level module renamed `core_d` so that it synthesizes into its own Quartus
...
// ---------------------------------------------------------------------------
// core_d -- the "original design" of Agilex 3 walkthrough 11.
//
