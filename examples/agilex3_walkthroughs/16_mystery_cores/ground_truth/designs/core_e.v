// ---------------------------------------------------------------------------
// core_e -- GROUND TRUTH for walkthrough 16.  Do not read this while doing the
// exercise; cores/core_e.anon.hal.v is the exercise.
//
// This is walkthrough 15's design.v verbatim below the header, with the
// top-level module renamed `core_e` so that it synthesizes into its own Quartus
...
// ---------------------------------------------------------------------------
// core_e -- the "original design" of Agilex 3 walkthrough 15.
//
...
// DSP_BLOCK_BALANCING assignment in quartus/core_e.qsf) forces it into ALMs.
