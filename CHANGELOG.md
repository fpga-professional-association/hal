...
* Plugins
  ...
  * simulation
    ...
    * added tests for the built-in engine: an output pin without a function that drives a net, one that drives nothing, a run ten times longer than the clock default it used to fall back to, and one that repeats a run whose clock net carries two events per time slot and compares the samples of a combinational net across the repetitions
