...
namespace hal {
     ...
     */
    TEST_F(UtilsTest, check_folder_exists_and_is_accessible) {
        TEST_START
     ...
     */
    TEST_F(UtilsTest, check_get_first_directory_exists) {
        TEST_START
     ...
     * Functions: get_file
     */
    TEST_F(UtilsTest, check_get_file) {
        TEST_START
