...
namespace hal {
    ...
    protected:
        const std::string m_min_gl_content = "library (MIN_TEST_GATE_LIBRARY_FOR_PARSER_MANAGER_TESTS) {\n"
                                             "    define(cell);\n"
                                             "    cell(gate_1_to_1) {\n"
        ...
        virtual void SetUp() {
            ...
            m_g_lib_path = test_utils::create_sandbox_file("min_test_gate_lib_for_parser_manager_tests.lib", m_min_gl_content);
